...
const contracts=[
 {id:'aave-v3-flash',name:'Aave V3 Flash Arbitrage',family:'Flashloan provider',file:'contracts/AaveV3FlashArbitrage.sol',description:'Single-provider round-trip flashloan template with repayment and profit-floor checks.'},
 {id:'aave-v3-two-router',name:'Aave V3 Two-Router Arbitrage',family:'Flashloan + mixed venues',file:'contracts/archive/AaveV3TwoRouterArbitrage.sol',description:'Borrow one asset, swap through router A, reverse through router B, repay and enforce minimum profit.'},
 {id:'liquidity-funded',name:'Liquidity Funded Executor',family:'No flashloan',file:'contracts/archive/LiquidityFundedExecutor.sol',description:'Owner-funded inventory executor for routes where capital is supplied by the contract owner.'},
 {id:'mixed-provider',name:'Mixed Liquidity / Multi-Provider',family:'Archive extension',file:'archive/README.md',description:'Architecture reserved for mixed funding and multiple flashloan-provider adapters; provider addresses must be verified before deployment.'}
];
